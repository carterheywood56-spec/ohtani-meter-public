...
- [x] 最新スコア投稿（URL付き）を週1回のペースで開始 👤 `[X]`
  ...
  - 毎週日曜日に実施する運用に決定（4/19初回、case-study.htmlへのリンク付き）
...
| 指標 | 値 | 備考 |
|---|---|---|
| X リンククリック | 0 | Week2は新規URL付き投稿なし |
| 「参考・納得」反応 | 0 | |
| GoatCounter PV | index:3 / method:3 / case-study:0 / faq:0 / X経由:4 | |

---

### Week 3（4/20〜4/26）日曜: 4/26
...
### Week 5（5/4〜5/8）日曜: 5/10（最終振り返り前）
